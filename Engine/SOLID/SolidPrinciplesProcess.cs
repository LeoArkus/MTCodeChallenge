...
namespace Engine.SOLID
{
    public class SolidPrinciplesProcess : IProcessSolidPrinciplesInfo
    {
        ...
        private readonly Dictionary<SolidPrinciplesTypes, string> _solidPrinciplesInfoDict = new()
        {
            ...
            {SolidPrinciplesTypes.LiskovSubstitution,"LSP: 'If S is subtype of T, objects of type T should be replaceable with objects of type S without altering the program/result or causing an unwanted behaviour.'"},
